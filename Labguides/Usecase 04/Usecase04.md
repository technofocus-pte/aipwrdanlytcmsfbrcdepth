...
2.  In the **Microsoft Fabric** window, enter your credentials, and
    ...
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image2.png)

3.  Then, In the **Microsoft** window enter the password and click on
    the **Sign in** button.

    > ![A login screen with a red box and blue text AI-generated content may
	> be incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image3.png)

4.  In **Stay signed in?** window, click on the **Yes** button.

    > ![A screenshot of a computer error AI-generated content may be
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image4.png)

    > ![A screenshot of a computer AI-generated content may be
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image5.png)

5.  On the Microsoft **Fabric Home Page**, select **New workspace**
    option.

    > ![A screenshot of a computer AI-generated content may be
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image6.png)
...
6.  In the **Create a workspace** tab, enter the following details and
    ...
    |  |  |
    |----|----|
    |Name	| +++Data-Factory@lab.LabInstance.Id+++ (Must be a unique value)| 
    ...
    > ![A screenshot of a computer AI-generated content may be
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image8.png)

7.  Wait for the deployment to complete. It'll take approximately 2-3
    minutes.

    > ![A screenshot of a computer AI-generated content may be
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image9.png)
...
1.  In the **Data-Factory@lab.LabInstance.Id** workspace page, navigate and click on
    **+New item** button
    ...
    > ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image10.png)

3.  Filter for, and select, the **+++Lakehouse+++** tile.

    > ![A screenshot of a computer AI-generated content may be
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image11.png)

3.  In the **New lakehouse** dialog box, enter
    **+++DataFactoryLakehouse+++** in the **Name** field, click on the
    **Create** button and open the new lakehouse.

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image12.png)

    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image13.png)
...
1.  Select the **+ New item** option on the workspace page.
	...
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image15.png)

2.  Select **Data Pipeline** from the new item flyout menu.

	> ![A screenshot of a computer AI-generated content may be
	incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image16.png)
...
1.  In the **First_Pipeline1** home page, Select **Copy data assistant**
    ...
    > ![A screenshot of a computer AI-generated content may be
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image18.png)

2.  The **Copy data** dialog is displayed with the first step, **Choose
    data source**, highlighted. Select  **Sample data** section, and
    select the **NYC Taxi-Green** data source type.

    > ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image19.png)

3.  In the **Connect to data source**, click on **Next** button.

    > ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image20.png)

4.  Select **OneLake catalog** and select the existing Lakehouse, **DataFactoryLakehouse**, on the
...
5.  Now configure the details of your Lakehouse destination on
    the **Connect to data destination** page, and select **Next**.

    | **Field**  | **Value** |
    |---|---|
    |Root folder | **Tables** |
    | Load settings | **Load to a new table** |
    | Table | **+++Bronze+++** |

    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image23.png)
...
6. Finally, on the **Review + save** page of the copy data assistant, review the
   ...
   next step. Then select **OK**.
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image22.png)
...
1.  On the **Home** tab of the pipeline editor window, then select
    ...
    > ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image24.png)

2.  In the **Save and run?** dialog box, click on **Save and run**
    button to execute these activities. This activity will take around
    12-13 min.

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image25.png)

    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image26.png)
...
3.  You can monitor the run and check the results on the **Output** tab
	...
	> ![A screenshot of a computer AI-generated content may be
	incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image27.png)

4.  The run details show 76,513,115 rows read and written.

    > ![A screenshot of a computer AI-generated content may be
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image28.png)
...
5.  Expand the **Duration breakdown** section to see the duration of
	...
	> ![A screenshot of a computer AI-generated content may be
	incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image29.png)
...
1.  On the **First_Pipeline1** page, from the sidebar select **Create.**
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image30.png)

2.  On the **new item** page, to create a new dataflow gen2, click
    on **Dataflow Gen2** under the **Data Factory.** 

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image31.png)

3.  Provide a New Dataflow Gen2 Name as
    **+++nyc_taxi_data_with_discounts+++** and then select **Create**.

    > ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image32.png)

4.  From the new dataflow menu, under the **Power Query** pane click on
    **Get data drop down**, then select **More...**.

    > ![A screenshot of a computer Description automatically
    > generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image33.png)

5.  In the **Choose data source** tab, search box search type
    **+++Lakehouse+++** and then click on the **Lakehouse** connector.

    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image34.png)
...
6.  The **Connect to data source** dialog appears, and a new connection
    ...
    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image35.png)
...
7.  The **Choose data** dialog is displayed. Use the navigation pane to
    ...
    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image36.png)

8.  You'll see the canvas is now populated with the data.

    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image37.png)
...
4.  Select the **storeAndFwdFlag** column's filter and sort dropdown
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image41.png)

5.  Select '**Y'** to show only rows where a discount was applied, and
    then select **OK**.

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image42.png)
...
6.  Select the **Ipep_Pickup_Datetime** column sort and filter dropdown
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image43.png)

7.  In the **Filter rows** dialog, select dates between **January 1,
    2019**, and **January 31, 2019**, then select **OK**.

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image44.png)
...
1.  From the **Home** tab in the dataflow editor menu, select the **Get
    ...
    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image45.png)

2.  In the **Connect to data source** pane, under **Connection
    settings**, set the following fields and then select the **Next** button.
    
    | Field | Value |
    |---|---|
    | Link to file | **Selected** |
    | Connection | **+++https://raw.githubusercontent.com/ekote/azure-architect/master/Generated-NYC-Taxi-Green-Discounts.csv+++** |
    | Connection name | **+++dsConnect@lab.LabInstance.Id+++** |
    | Authentication kind | **Anonymous** |

    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image46.jpeg)

3.  On the **Preview file data** dialog, select **Create**.

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image47.png)
...
1.  Reviewing the data, we see the headers appear to be in the first
    ...
    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image48.png)
...
2.  Right-click the **VendorID** column, and from the context menu
    ...
    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image50.png)
...
3.  With the table unpivoted, rename
    ...
    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image52.png)
...
4.  Change the data type of the **Date** column by selecting the data
    ...
    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image53.png)
...
2.  Select the **Bronze** query, and on the **Home** tab, Select
    ...
    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image57.png)
...
4.  Choose each of the two suggested column mappings, one at a time,
    ...
    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image59.png)

5.  A message is shown asking you to allow combining data from multiple
    data sources to view the results. Select **OK** 

    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image60.png)
...
6.  In the table area, you'll initially see a warning that "The
    ...
    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image61.png)
...
7.  In Privacy Levels dialog box, select the check box **Ignore Privacy
    ...
    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image62.png)

    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image63.png)
...
8.  Notice how a new query was created in Diagram view showing the
    ...
    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image64.png)
...
9.  With the discount value now at the row level, we can create a new
    ...
    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image65.png)
...
10. On the **Custom column** dialog, you can use the [Power Query
    ...
    your new column should be calculated. Enter the following, then select **OK**.
	...
	> ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image66.png)
      
	> ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image67.png)
...
12. Select the newly create **TotalAfterDiscount** column and then
	...
	>[!note]**Note**: If you can't find the **rounding** option, expand the menu to
	see **Number column**.

    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image68.png)
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image70.png)

13. On the **Round** dialog, enter **+++2+++** for the
    number of decimal places and then select **OK**.

    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image71.png)
...
1.  Select the **Output** merge query created previously. Then select
    ...
    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image75.png)

2.  From data destination list, select **Lakehouse** option under the
    New destination.

    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image76.png)

3.  On the **Connect to data destination** dialog, your connection
    should already be selected. Select **Next** to continue.

    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image77.png)
...
5.  On the **Choose destination target** dialog,
    browse to the **DataFactoryLakehouse** Lakehouse where you wish to load the data and name the
    new table **+++nyc_taxi_with_discounts+++**, then select **Next** again.

6.  On the **Choose destination settings** dialog, unselect **Use automatic settings**, leave the
    default **Replace** update method, double check that your columns
    are mapped correctly, and select **Save settings**.

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image79.png)
...
7.  Back in the main editor window, confirm that you see your output
    ...
    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image80.png)

    > ![A screenshot of a computer AI-generated content may be
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image81.png)

    > ![A screenshot of a computer AI-generated content may be
    > incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image82.png)

7.  In the **Data_Factor@lab.LabInstance.Id** pane, select **DataFactoryLakehouse** to
    view the new table loaded there.

    >[!note]**Note**: You may need to wait a few minutes for the table(s) to complete the run process and be loaded. You may also need to refresh the list of tables.
    
    > ![A screenshot of a computer AI-generated content may be incorrect.](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image83.png)

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image84.png)
...
1.  Navigate and click on **Data_Factory@lab.LabInstance.Id** Workspace on the left-sided
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image85.png)

2.  In the **Data_Factory@lab.LabInstance.Id** view, select the **First_Pipeline1**.

    > ![A screenshot of a computer Description automatically
	> generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image86.png)

3.  Select the **Activities** tab in the pipeline editor and find the
    **Office Outlook** activity.

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image87.png)
...
4.  Select and drag the On success path (a green checkbox on the top
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image88.png)
...
5.  Select the Office 365 Outlook activity from
    ...
    **Sign in** button.
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image89.png)

6. Select your Power BI organizational account (**@lab.CloudPortalCredential(User1).Username**)
...
7.  Select the Office 365 Outlook activity from the pipeline canvas, on
    ...
    - Enter your email address in the **To** section. If you want to use
     ...
     > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image90.png)
...
9.  For the **Body**, select the field again and choose the **View in
	...
	+++@concat('RunID = ', pipeline().RunId, ' ; ', 'Copied rows ', activity('Copy_data1').output.rowsCopied, ' ; ','Throughput ', activity('Copy_data1').output.throughput)+++

	>[!note] **Note:** Replace **Copy_data1** with the name of your own pipeline
	copy activity (example: **Copy_2ph**).
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image93.png)

10. Finally select the **Home** tab at the top of the pipeline editor,
    and choose **Run**. Then select **Save and run** on the
    confirmation dialog to execute these activities.

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image94.png)

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image95.png)

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image96.png)

11. After the pipeline runs successfully, check your email to find the
    confirmation email sent from the pipeline.

    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image97.png)

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image98.png)
...
1.  On the **Home** tab of the pipeline editor window,
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image99.png)

2.  Select **+ Add schedule** and configure the schedule as required then select **Save** and close the **Schedule** panel.
 
    >[!note]**Note**: The example here schedules the
    pipeline to execute daily at 8:00 PM until the end of the year.

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image100.png)
...
1.  Hover over the green line connecting the **Copy activity** and the
    **Office 365 Outlook** activity on your pipeline canvas, and select
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image101.png)

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image102.png)
...
3.  The newly created Dataflow activity is inserted between the Copy
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image103.png)

    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image104.png)
...
4.  Select the **Home** tab at the top of the
    ...
    > ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image105.png)

    > ![A screenshot of a computer Description automatically generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image106.png)
...
1.  Select your workspace, the **Data-Factory@lab.LabInstance.Id** from the left-hand
	...
	> ![](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image107.png)

2.  Select the  **Workspace settings** option on the workspace page
    located at the top right corner.

	> ![A screenshot of a computer Description automatically
	generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image108.png)

3.  Select **General tab** and then **Remove this workspace** at the bottom of the panel.

	> ![A screenshot of a computer Description automatically
	generated](https://raw.githubusercontent.com/technofocus-pte/aipwrdanlytcmsfbrcdepth/refs/heads/Cloud-slice/Labguides/Usecase%2004/media/image109.png)
